...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // Otherwise, reconnect the neighboring nodes to bypass curr
                else
                {
                ...
                return; // We can exit the function after we remove one node
            }
    ...
    {
        // Search for every node that matches 'oldValue' by starting at
        // the head of the list, and keep going through the whole list.
        Node? curr = _head;
        while (curr is not null)
        {
